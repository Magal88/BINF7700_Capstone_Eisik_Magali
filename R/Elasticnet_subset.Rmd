...
The R² of 0.71 indicates that about 71% of the variance in chronological age is explained by the model.
The MAE of 5.81 years shows that, on average, the predicted age deviates from the actual age by approximately 5 to 6 years. 
The RMSE of 6.71 years reflects the overall magnitude of prediction errors, giving slightly more weight to larger deviations.
