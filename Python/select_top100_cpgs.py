...
output_file = "GSE55763_top100_all_samples.csv"  # Name of the final CSV
...
# ---------------------------
# Select the top 100 most variable CpGs
# ---------------------------
top100 = all_data.loc[variances.nlargest(100).index, :]

# ---------------------------
# Save the final CSV
# ---------------------------
top100.to_csv(output_file, index=False)
print(f"Top 100 CpGs saved to {output_file}")
